...
public:
   ...
   virtual  ~Tracker() { }
    ...
    virtual void init(const cv::Rect &roi, unsigned int vaSurfaceID, int width, int height) = 0;
    virtual cv::Rect  update( unsigned int vaSurfaceID, int width, int height)=0;
